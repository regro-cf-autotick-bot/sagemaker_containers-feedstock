...
validate_recipe_outputs "sagemaker_containers-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="sagemaker_containers-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi